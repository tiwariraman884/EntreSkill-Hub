...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all duration-300 ease-out outline-none select-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-primary/30 bg-white text-primary hover:bg-primary/5 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10 active:scale-[0.98]",
        secondary:
        ...
        glass:
          "bg-white/70 backdrop-blur-xl border border-white/20 text-foreground shadow-lg hover:bg-white/80 hover:shadow-xl hover:border-white/30 active:scale-[0.98] dark:bg-ink/10 dark:border-white/10 dark:hover:bg-ink/20",
        destructive:
      ...
      size: {
        ...
        xl: "h-14 gap-2.5 px-8 has-data-[icon=inline-end]:pr-6 has-data-[icon=inline-start]:pl-6 text-lg",
        icon: "size-10",
        "icon-xs":
