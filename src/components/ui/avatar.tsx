...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "flex size-full items-center justify-center rounded-full bg-gradient-to-br from-indigo/10 to-indigo/20 text-sm font-semibold text-indigo ring-2 ring-white shadow-md group-data-[size=sm]/avatar:text-xs group-data-[size=lg]/avatar:text-base group-data-[size=xl]/avatar:text-lg",
        className
      )}
      {...props}
    />
...
function AvatarBadge({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn(
        "absolute right-0 bottom-0 z-10 inline-flex items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 text-white ring-3 ring-white shadow-lg",
...
function AvatarGroupCount({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-indigo to-indigo-light text-sm font-semibold text-white ring-3 ring-white shadow-md group-has-data-[size=lg]/avatar-group:size-12 group-has-data-[size=sm]/avatar-group:size-8 group-has-data-[size=xl]/avatar-group:size-16",
        className
      )}
      {...props}
    />
