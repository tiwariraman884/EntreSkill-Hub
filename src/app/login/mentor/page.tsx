...
import {
  BookOpen, ShieldCheck, Users, MessageCircle, Star, Rocket, HelpCircle,
} from "lucide-react";
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex">
      ...
      <aside className="hidden lg:flex flex-col justify-between w-[46%] xl:w-[44%] text-foreground px-12 py-16 relative overflow-hidden shrink-0 border-r bg-muted/30">
        ...
        <div className="relative z-10 space-y-10">
          ...
          <div className="space-y-3">
            ...
            {[
              ...
              <div key={m.name} className="flex items-center gap-3 p-3 rounded-xl bg-background border">
        ...
        {/* Bottom stat */}
        <div className="relative z-10 border-t pt-8 grid grid-cols-3 gap-4 text-center">
          {[
